...
class ExceptionsPage(BasePage):
    ...
    __row1_input_element = (By.XPATH, "//div[@id='row2']/input")
    __row2_input_element = (By.XPATH, "//div[@id='row2']/input")
    __row1_save_btn = (By.XPATH, "//div[@id='row1']/button[@name='Save']")
    __row2_save_btn = (By.XPATH, "//div[@id='row2']/button[@name='Save']")
    __confirmation_element = (By.ID, "confirmation")
    __instructions_element = (By.ID, "instructions")
    __row_1_edit_btn = (By.ID, "edit_btn")
    ...
    def modify_row_1_input(self, food: str):
        super()._click(self.__row_1_edit_btn)
        super()._wait_until_element_is_clickable(self.__row1_input_element)
        super()._clear(self.__row1_input_element)
        super()._type(self.__row1_input_element, food)
